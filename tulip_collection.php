...
// Fetch products for Tulip Collection (category_id = 4)
$product_query = $conn->query("SELECT * FROM products WHERE category_id=4");
?>
...
<title>Tulip Collection - Flower Shop</title>
<style>
