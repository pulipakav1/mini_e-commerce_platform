...
// Fetch products for Style Accessories (category_id = 3)
$product_query = $conn->query("SELECT * FROM products WHERE category_id=3");
?>
...
<title>Style Accessories - Flower Shop</title>
<style>
