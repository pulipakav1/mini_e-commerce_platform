...
$product_query = $conn->prepare("SELECT * FROM products WHERE category_id = ?");
$product_query->bind_param("i", $category_id);
...
<title><?php echo $category_name; ?> - Flower Shop</title>
<style>
body { 
...
if ($product_result->num_rows > 0) {
    ...
    if ($product['quantity'] > 0) {
        ...
        echo '<input type="hidden" name="redirect" value="category.php?id='.$category_id.'">';
